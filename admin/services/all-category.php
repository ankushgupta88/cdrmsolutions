          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                //Get all services_cat
                $service_cat_query = "SELECT * FROM `services_cat`";
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php if($service_cat_result->num_rows >= 1){
                      $count = 1;
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-info btn-sm" href="<?php echo ADMIN_URL.'/services/edit-category.php?id='.$cat['id']; ?>"><i class="fas fa-pencil-alt"></i>Edit</a> 

                          <a class="btn btn-danger btn-sm" href="<?php echo ADMIN_URL.'/services/delete-category.php?id='.$cat['id']; ?>"><i class="fas fa-trash"></i>Delete</a>
