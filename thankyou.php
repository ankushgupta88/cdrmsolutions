...
<head>
    ...
    <link rel="stylesheet" href="assets/css/responsive.css"> 
     <script>
      gtag('event', 'conversion', {'send_to': 'AW-847868929/Dol_CIuDv_ACEIHopZQD'});
    </script> 
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-6">
                    <h2 class="comming-soon-title">Thank you</h2>
                    <div class="comming-soon-wrap">
                        <div class="countdown countdown--alt"></div>
                    </div>
                    <div class="newsletter-subcribe text-center">
                        <p>Our team will reach you soon!!</p>
                        
                    </div>
                </div>
                <div class="col-xl-6 col-lg-7 col-md-6 offset-xl-1 text-center">
                    <div class="comming-soon-thumb">
                        <img src="assets/img/thank-you.jpg" alt="404">
                    </div>
                </div>
            </div>
        </div>
